    ...
    if not num != num:
        ...
        try:
            ...
            dict_data_out = {
                ...
                "Reactive_Power_Last_Demand": incoming_data[49],

                "Apparent_Power_Last_Demand": incoming_data[50],

                "Current_Avg_Last_Demand": incoming_data[51],
                "Current_Avg_Present_Demand": incoming_data[52],
...
# q = Read_PM2xxx(2, 1)
client.unit_id(rs_485_address)
incoming_data_part1 = client.multiple_register_read("holding", 21300, 10, "FLOAT32")
incoming_data_part2 = client.multiple_register_read("holding", 21322, 16, "FLOAT32")
